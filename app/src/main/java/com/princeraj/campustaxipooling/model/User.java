...
public class User implements java.io.Serializable {
    ...
    public void setSubscriptionTier(String s) { this.subscriptionTier = s; }
    ...
    @PropertyName("isPhoneVisibleToMatches")
    public void setPhoneVisibleToMatches(boolean v) { isPhoneVisibleToMatches = v; }

    @PropertyName("isVerifiedDriver")
    public void setVerifiedDriver(boolean v) { isVerifiedDriver = v; }

    public void setDriverLicense(String l) { this.driverLicense = l; }
    public void setVehicleModel(String m) { this.vehicleModel = m; }
    public void setVehicleNumber(String n) { this.vehicleNumber = n; }
    public void setRatingCount(long c) { this.ratingCount = c; }
    public void setAverageRating(double r) { this.averageRating = r; }
    public void setBanReason(String r) { this.banReason = r; }
    public void setReportCount(long c) { this.reportCount = c; }
    public void setFcmToken(String t) { this.fcmToken = t; }
